...
CURRENTDIR=`pwd`
MAINFILE="mwi.php" # this should be the name of your main php file in the wordpress plugin
SVNUSER="jamesckemp" # your svn username (case sensitive)
