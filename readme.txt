...
Please visit the [Magento Wordpress Integration website](http://mwi-plugin.com/documentation/installation/) for installation details.
...
= 2.0 =
* WARNING: This plugin has been completely rewritten and the old functions from MWI v1.* will no longer work. If you aren't prepared to change the functions, I'd advise not upgrading! Read the [documentation](http://mwi-plugin.com/documentation/) for more information.
